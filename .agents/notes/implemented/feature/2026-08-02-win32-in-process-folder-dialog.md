...
- The binding test pins NUL-terminated `char16_t` decoding without an external buffer view. A complete selection through the packaged executable remains a manual Windows check deferred to the Windows CI roadmap.
